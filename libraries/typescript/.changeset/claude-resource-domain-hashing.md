...
Client identity comes from the per-request `_meta` envelope (`io.modelcontextprotocol/clientInfo`), so this applies to 2026-07-28-era traffic; 2025-era requests carry no per-request identity and keep the verbatim domain.
