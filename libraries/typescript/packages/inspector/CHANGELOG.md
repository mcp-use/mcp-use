...
- 302af01: Render chat MCP Apps with the registered MCP connection id while preserving the logical server id for chat state and storage.

## 20.3.5-canary.0

### Patch Changes

- @mcp-use/agent@2.0.13-canary.0
- mcp-use@2.4.1-canary.0
...
- @mcp-use/agent@2.0.11-canary.0
- mcp-use@2.3.4-canary.0
...
- 6ed2974: Warn in Inspector chat when an MCP server exceeds the documented 128-tool limit for OpenAI or Gemini models.

## 20.3.2-canary.0

### Patch Changes

- @mcp-use/agent@2.0.10-canary.0
- mcp-use@2.3.3-canary.0

## 20.3.1

### Patch Changes

- 1af9beb: Show the correlated request method and latency on JSON-RPC response rows.
