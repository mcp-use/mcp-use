...
import { z } from "zod";
import ProductSearchResult from "./components/product-search-result/widget";
...
/**
 * Inline JSX widget: components/product-search-result (see migration-from-resources docs).
 */
