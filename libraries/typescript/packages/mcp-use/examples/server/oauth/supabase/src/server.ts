...
import { createMCPServer, oauthSupabaseProvider, error, object } from "mcp-use/server";
...
server.tool({
  ...
  description: "Fetch user profile from Supabase using the authenticated token",
}, async (_args, ctx) => {
  try {
