...
import { z } from "zod";
import EverythingWidget from "./components/EverythingWidget";
...
// ============================================================================
// TOOL: Inline JSX widget (components/EverythingWidget.tsx)
// ============================================================================
  ...
  async ({ query }) => {
    ...
    return (
      <EverythingWidget
        ...
        _invoking="Loading items..."
        _invoked="Items loaded"
      />
    );
  }
);
