...
import type { CSPConfig } from "./adapters/types.js";

interface ExtractedInlineJsxMeta {
 ...
 */
function extractStringProp(src: string, propName: string): string | undefined {
...
function extractObjectProp(
  ...
  return parseJsObjectLiteral(src.slice(braceStart, braceEnd + 1)) as
    | CSPConfig
    | undefined;
}
