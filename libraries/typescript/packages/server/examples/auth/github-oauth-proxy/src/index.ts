...
const server = new MCPServer({
  ...
  // Allow the hosted Inspector to reach this localhost-only demo. Production
  // deployments should replace these with the origins of their real clients.
  cors: {
    origin: [
      "https://inspector.manufact.com",
      "http://localhost:3000",
      "http://127.0.0.1:3000",
    ],
    credentials: true,
