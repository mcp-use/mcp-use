...
The non-mixed direct-provider examples expose an identity tool and never
issue, proxy, or forward access tokens. Mixed OAuth also includes public tools.
The GitHub proxy example instead
