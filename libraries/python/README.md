...
[![CI](https://img.shields.io/github/actions/workflow/status/mcp-use/mcp-use/ci.yml?branch=main&label=CI&style=flat)](https://github.com/mcp-use/mcp-use/actions/workflows/ci.yml)

| Supports       |                                                                       |
| :------------- | :-------------------------------------------------------------------- |
| **Primitives** | Tools, Resources, Prompts, Sampling, Elicitation, Roots, Authentication |
