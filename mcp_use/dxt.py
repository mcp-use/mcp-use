...
class DXTParser:
    ...
    def extract(self) -> None:
        ...
        try:
            ...
            raise DXTError(f"Invalid DXT file (not a valid zip): {self.dxt_path}")
        except Exception as e:
            self.cleanup()
            raise DXTError(f"Failed to extract DXT file: {e}")
    ...
    def _load_manifest(self) -> None:
        ...
        try:
            ...
            raise DXTManifestError(f"Invalid manifest.json: {e}")
    ...
    def get_mcp_config(self, user_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def load_dxt_config(dxt_path: str, user_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
