...
<div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-3 gap-x-6 gap-y-6">
  <SimpleSplitCard
    img="/images/agent.jpg"
    title="Agent"
    description="Build tool-using AI agents."
    leftHref="/python/agent/streaming"
    rightHref="/typescript"
  ...
  <SimpleSplitCard
    ...
    leftHref="/python/client/connection-types"
    rightHref="/typescript"
    leftLogo="/images/pythonlogo.svg"
    rightLogo="/images/typescriptlogo.svg"
  />
