...
if __name__ == "__main__":
    server.run(transport="streamable-http", host="127.0.0.1", port=3000)
```
...
For more details, see the [Python Server documentation](/python/server/index) or [TypeScript Server documentation](/typescript/server/index).
</Step>
