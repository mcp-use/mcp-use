...
The Inspector previews the MCP Apps side of dual-protocol servers. It does not emulate ChatGPT. Use ChatGPT developer mode for Apps SDK-only verification.
...
<CardGroup cols={2}>
  ...
  >
    Preview MCP Apps widgets locally. ChatGPT-specific checks stay in ChatGPT developer mode.
  </Card>
</CardGroup>
