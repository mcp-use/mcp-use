...
4. **Pre-built React Hooks**: Use `useWidget()` for props, state, tool calls, and display modes; [streaming tool input](/typescript/react/usewidget#streaming-tool-arguments) for live previews when the host supports it (MCP Apps / Inspector)
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="puzzle-piece"
    href="/typescript/react/mcpuseprovider"
  >
...
- [Widget Components Reference](/typescript/react/usewidget) - Complete API documentation
