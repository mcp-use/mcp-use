...
<Tip>
For multi-server setups, tool restrictions, and advanced configuration options, see the [Configuration Guide](/essentials/configuration).
</Tip>
...
<CardGroup cols={3}>
  <Card title="Configuration" icon="gear" href="/essentials/configuration">
    Multi-server setups, tool restrictions, adapters, and advanced configuration
  </Card>
