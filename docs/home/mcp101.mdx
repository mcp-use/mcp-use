...
Chat interfaces are becoming how most products are used. The major AI platforms now ship official MCP stores where you can publish your server and reach users directly inside their chat interface - no app install, no separate login.

<CardGroup cols={3}>
  <Card title="Claude" img="/images/stores/claude.png" href="https://claude.ai/directory/connectors">
    Publish to Anthropic's MCP integrations directory.
  </Card>
  <Card title="ChatGPT" img="/images/stores/chat.png" href="https://chatgpt.com/apps">
    Reach users through the ChatGPT connector store.
  </Card>
  <Card title="Cursor" img="/images/stores/cursor.png" href="https://cursor.com/marketplace">
    List your server in Cursor's MCP marketplace.
  </Card>
</CardGroup>
