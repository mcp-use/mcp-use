...
<Steps>
  <Step title="Add the extension">
    Open the [WebMCP Inspector listing](https://chromewebstore.google.com/detail/webmcp-inspector/dgdidjgjofcenipdfaoebdeeppideadh)
...
<Note>
  You only need this if you are working on the extension itself. To use the Inspector,
  install it from the Chrome Web Store above.
</Note>
