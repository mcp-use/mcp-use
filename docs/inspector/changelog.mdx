...
<Update label="v9.0.2" description="June 2026">
  ## mcp-use v1.32.0
  Patch release paired with `mcp-use` v1.32.0 — picks up OAuth token endpoint discovery on `useMcp().authTokens`; no inspector-specific runtime changes.
