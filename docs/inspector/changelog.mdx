...
<Update label="v11.0.0" description="June 2026">
  ...
  ## MCP Apps primary widget runtime & host context styles
  Major release paired with `mcp-use` v1.33.0 — widgets now render with MCP Apps as the primary runtime and apply host context style variables, while the Apps SDK preview tab remains for `window.openai`-only widgets.
