...
<Update label="v7.0.1" description="June 2026">
  ## mcp-use v1.29.1
  Patch release paired with `mcp-use` v1.29.1  -  picks up the OAuth `/sse` bearer-auth fix and workspace security dependency bumps; no inspector-specific runtime changes.
