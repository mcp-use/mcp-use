...
See [Widget Lifecycle](/typescript/api-reference/react/usewidget#widget-lifecycle) for complete details on `isPending` behavior and implementation patterns.
...
- [Widget Components](/typescript/api-reference/react/usewidget) - React hooks and components
