...
<Update label="v1.12.0 - January 2026">
  ...
  - **New**: Browser Telemetry using `posthog-js` for browser environments, separate from Node.js telemetry
  ...
  ### React Components
  - **New**: `AddToClientDropdown` component for adding MCP servers to clients with enhanced UI and functionality
...
<Update label="v1.11.2 - December 2025">
  ## Documentation Updates
  - **Enhancement**: Updated examples and documentation to use preferred methods and APIs
</Update>

<Update label="v1.11.1 - December 2025">
  ## Bug Fixes
  - **Fix**: Widget props not picked up when using Zod schemas
</Update>
