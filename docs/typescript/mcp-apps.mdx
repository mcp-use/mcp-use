...
The Inspector previews the MCP Apps side of dual-protocol servers. It does not emulate ChatGPT. See [Debug widgets in the Inspector](/inspector/debugging-chatgpt-apps).
