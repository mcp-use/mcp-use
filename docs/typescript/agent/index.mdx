...
<CodeGroup>
  ```bash npm npm install @mcp-use/agent @mcp-use/client ``` ```bash pnpm pnpm
  add @mcp-use/agent @mcp-use/client ``` ```bash yarn yarn add @mcp-use/agent
  @mcp-use/client ```
</CodeGroup>

<CodeGroup>
  ```bash OpenAI npm install @langchain/openai ``` ```bash Anthropic npm install
  @langchain/anthropic ``` ```bash Google npm install @langchain/google-genai
  ``` ```bash Groq npm install @langchain/groq ```
</CodeGroup>
