...
Open `http://localhost:3000/inspector`, run `search-products`, and confirm the widget renders below the tool result. The Inspector previews MCP Apps widgets; ChatGPT-specific Apps SDK behavior is verified in ChatGPT developer mode.
