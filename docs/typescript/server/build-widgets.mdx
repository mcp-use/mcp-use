...
- Use [Model context](/typescript/server/model-context) to decide what the model should know about widget state.
- Use [Interactivity](/typescript/server/interactivity) when the widget needs buttons, state, tool calls, or follow-up messages.
