...
// With icons and website URL (SEP-973)
const server = createMCPServer('my-server', {
  version: '1.0.0',
  description: 'My MCP server',
  icons: [
...
interface ServerConfig {
  ...
  icons?: Icon[]     // Optional list of icons for this server (SEP-973)
  websiteUrl?: string // Optional website URL for this server (SEP-973)
}

interface Icon {
  src: string         // URI pointing to icon resource or base64 data URI
  mimeType?: string   // Optional MIME type override
  sizes?: string      // Icon sizes (e.g., "48x48", "any", "16x16 32x32 48x48")
}
```
...
server.resource({
  ...
  icons: [
    {
      src: 'https://example.com/config-icon.png',
      mimeType: 'image/png',
      sizes: '32x32'
    }
  ],
...
server.prompt({
  ...
  icons: [
    {
      src: 'https://example.com/code-review-icon.png',
      mimeType: 'image/png',
      sizes: '48x48'
    }
  ],
...
interface ToolDefinition {
  ...
  icons?: Icon[]                  // Optional list of icons for this tool (SEP-973)
...
interface ResourceDefinition {
  ...
  icons?: Icon[]                     // Optional list of icons for this resource (SEP-973)
...
interface ResourceTemplateDefinition {
  ...
  icons?: Icon[]                           // Optional list of icons for this resource template (SEP-973)
  annotations?: ResourceAnnotations        // Optional annotations
...
interface PromptDefinition {
  ...
  icons?: Icon[]            // Optional list of icons for this prompt (SEP-973)
