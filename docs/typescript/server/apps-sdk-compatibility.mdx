...
- Use [Build widgets](/typescript/server/build-widgets) for the normal MCP Apps workflow.
- Use [Model context](/typescript/server/model-context) to decide what the model and widget should see.
- Use [Interactivity](/typescript/server/interactivity) for tool calls, state, follow-up messages, and display controls.
