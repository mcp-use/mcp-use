...
If you have existing widgets using `type: "appsSdk"`, migration is simple:
...
That's it! The metadata structure is identical, and your widget code requires **no changes**.
...
- [Creating Apps SDK Server](/typescript/server/creating-apps-sdk-server) - Complete server setup guide
