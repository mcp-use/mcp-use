...
Apps SDK APIs remain useful for ChatGPT-specific host extensions that are not part of the shared MCP Apps spec yet. Use [Apps SDK compatibility](/typescript/server/apps-sdk-compatibility) when you need to understand that boundary.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Build widgets"
    icon="panel-top"
    href="/typescript/server/build-widgets"
  >
  ...
  <Card
    title="Model context"
    icon="brain"
    href="/typescript/server/model-context"
  >
  ...
  <Card
    ...
    href="/typescript/server/interactivity"
  >
  ...
  <Card
    ...
    icon="openai"
    href="/typescript/server/apps-sdk-compatibility"
  >
  ...
  <Card
    ...
    icon="shield"
    href="/typescript/server/content-security-policy"
  >
