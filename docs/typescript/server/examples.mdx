...
A complete example demonstrating SEP-973 icons and website URL features. This example shows how to add custom icons to your server, tools, resources, and prompts, as well as how to add a website URL to your server configuration.

**Location**: `examples/server/icons-and-website/`
...
See the [example README](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/server/icons-and-website) for complete documentation and usage instructions.
