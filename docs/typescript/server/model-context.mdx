...
- Use [Build widgets](/typescript/server/build-widgets) for the server and React setup.
- Use [Interactivity](/typescript/server/interactivity) for buttons, tool calls, and follow-up messages.
