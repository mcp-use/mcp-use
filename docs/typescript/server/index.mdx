...
If you are starting from scratch, use the [TypeScript quickstart](/typescript/getting-started/quickstart) to scaffold a server. Use the [MCP Apps quickstart](/typescript/server/creating-mcp-apps-server) when the server should return React widgets.
...
Learn more in [MCP Apps](/typescript/server/mcp-apps) and [useWidget()](/typescript/api-reference/react/usewidget).
...
<CardGroup cols={3}>
  ...
  <Card
    title="Configuration"
    icon="cog"
    href="/typescript/server/configuration"
  >
