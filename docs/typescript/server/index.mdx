...
### **Server Instance**
The main `McpServer` class created via `createMCPServer()`. It orchestrates all MCP functionality, manages the Express application, and handles client connections.
