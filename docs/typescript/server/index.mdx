...
If you are starting from scratch, use the [TypeScript quickstart](/typescript/getting-started/quickstart) to scaffold a server. Use [Build your first MCP App](/typescript/server/creating-mcp-apps-server) when the server should return React widgets.
