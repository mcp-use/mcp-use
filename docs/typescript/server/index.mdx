...
class McpServer {
  ...
  // Middleware hooks (intercept protocol operations)
...
- **[Middleware Hooks](/typescript/server/middleware-hooks)**: Intercept protocol operations to filter tools, enforce authorization, and add cross-cutting logic
...
<CardGroup cols={3}>
  ...
  <Card title="Middleware Hooks" icon="layers" href="/typescript/server/middleware-hooks">
    Filter tools, enforce authorization, and add cross-cutting logic per-request
  </Card>
