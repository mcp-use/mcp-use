---
title: "OAuth Proxy"
description: "Bridge providers that don't support Dynamic Client Registration (Google, GitHub, Okta, Azure AD, and more) to your MCP server"
icon: "shuffle"
---
...
- [jose library](https://github.com/panva/jose) for JWT / JWKS verification
