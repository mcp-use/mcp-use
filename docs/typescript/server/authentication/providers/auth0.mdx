...
<Tabs>
  <Tab title="DCR (Built-in)">
    ...
    <Note>
      To use the built-in Auth0 provider, you need to join Auth0's Early Access program. Complete [this form](https://forms.gle/hvJ1ZRLmHr9YjV2a9) to get access.
    </Note>
...
- [GitHub Example (DCR)](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/server/oauth/auth0)
- [GitHub Example (Proxy)](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/mcp-use/examples/server/oauth/auth0-proxy)
