...
- **[Proxy Mode](/typescript/server/authentication/oauth-modes)** (Default) - Server proxies OAuth requests
- **[Direct Mode](/typescript/server/authentication/oauth-modes)** - Clients authenticate directly with provider
...
- [OAuth Modes](/typescript/server/authentication/oauth-modes) - Learn about proxy vs direct mode
- [User Context](/typescript/server/authentication/user-context) - Access user information in tools
- [RBAC](/typescript/server/authentication/rbac) - Implement role-based access control
- [Security](/typescript/server/authentication/security) - Follow security best practices
- [Testing](/typescript/server/authentication/testing) - Test your OAuth implementation
