...
| Situation                                                            | Use                                                                    |
| -------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| You use Auth0, Better Auth, Clerk, Convex, Keycloak, Supabase, or WorkOS | A built-in provider                                                    |
...
- [Convex](/typescript/server/authentication/providers/convex): Convex OAuth Provider with Dynamic Client Registration.
