...
| Situation                                                            | Use                                                                    |
| -------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| You use Auth0, Better Auth, Clerk, Keycloak, Scalekit, Supabase, or WorkOS | A built-in provider                                                    |
...
- [Scalekit](/typescript/server/authentication/providers/scalekit): Scalekit MCP Auth with resource-id audience binding.
