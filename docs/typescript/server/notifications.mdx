---
title: "Notifications"
description: "Send and receive real-time notifications with connected clients"
icon: "bell"
---
...
- [Client Notifications](/typescript/client/notifications) - Handle notifications in your client
