...
If you don't set it at build time you must set it at runtime either by passing the `baseUrl` option to the `createMCPServer` function or by setting the `MCP_URL` environment variable.
