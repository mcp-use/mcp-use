...
For the main widget workflow, see [Build widgets](/typescript/server/build-widgets). For ChatGPT compatibility behavior, see [Apps SDK compatibility](/typescript/server/apps-sdk-compatibility).
