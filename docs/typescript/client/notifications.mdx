---
title: "Notifications"
description: "Handle real-time notifications from MCP servers and send notifications to servers"
icon: "bell-ring"
---
...
- [Server Notifications](/typescript/server/notifications) - Send notifications from your server
