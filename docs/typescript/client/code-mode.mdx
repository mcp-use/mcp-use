...
See [`examples/client/code_mode_example.ts`](../../examples/client/code_mode_example.ts) for a complete working example using the default VM executor with the filesystem MCP server.
...
See [`examples/client/code_mode_e2b_example.ts`](../../examples/client/code_mode_e2b_example.ts) for a complete working example using E2B cloud sandboxes.
...
- [Executor Architecture](/src/client/executors/README.md) - Technical implementation details
