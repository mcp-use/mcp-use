...
<Warning>
  **Security Considerations**: Code Mode executes user-generated code. Always
  use appropriate sandboxing: - **VM Executor**: Basic local sandboxing for
  trusted environments - **E2B Executor**: Strong cloud-based isolation for
  production use
</Warning>
...
```typescript
import { BaseCodeExecutor } from "@mcp-use/client";
...
console.log(
  `Found ${allResult.meta.result_count} tools out of ${allResult.meta.total_tools} total`,
);
...
- [Executor Architecture](https://github.com/mcp-use/mcp-use/tree/main/libraries/typescript/packages/client/src/client/executors/README.md) - Technical implementation details
