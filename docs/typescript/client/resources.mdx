...
<Tip>
  **Think of resources as endpoints**: Just like REST APIs have endpoints, MCP
  servers expose resources via URIs. The key difference is that resources are
  designed for AI context and can include rich metadata.
</Tip>
