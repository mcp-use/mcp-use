...
<CardGroup cols={3}>
  ...
  <Card title="Client Capabilities" icon="badge-check" href="/typescript/client/client-capabilities">
    Advertise roots, sampling, elicitation, and MCP Apps extensions
  </Card>
