...
<Callout type="info" title="Source Code">
  ...
  <a
    href="https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/core/node.ts"
    target="_blank"
    rel="noopener noreferrer"
  >
    https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/core/node.ts
  </a>
  <br />
  View the executor base types:{" "}
  <a
    href="https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/code-mode/executor.ts"
    target="_blank"
    rel="noopener noreferrer"
  >
    https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/code-mode/executor.ts
  </a>
  <br />
  View the Code Mode connector:{" "}
  <a
    href="https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/code-mode/connector.ts"
    target="_blank"
    rel="noopener noreferrer"
  >
    https://github.com/mcp-use/mcp-use/blob/main/libraries/typescript/packages/client/src/code-mode/connector.ts
  </a>
</Callout>
...
Options for the E2B cloud sandbox executor. Install the peer dependency first:
