...
> For the complete documentation index, see [llms.txt](https://docs.mcp-use.com/llms.txt).
</div>
...
- [ChatGPT Apps SDK](/typescript/server/ui-widgets): ChatGPT-specific widget protocol details.
