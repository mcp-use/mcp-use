...
| Section | Description |
|---------|-------------|
| [Agent](#mcp-agent) | An AI Agent with tool calling capabilities through MCP connections |
| [Client](#mcp-client) | A full featured MCP Client implementation for TypeScript |
| [Server](#mcp-server) | The MCP Server framework implementation for TypeScript, with Apps SDK and MCP-UI support |
...
<CardGroup cols={3}>
  <Card title="Configuration" icon="cog" href="/typescript/getting-started/configuration">
