...
| Section | Description |
|---------|-------------|
| [MCP Server](#mcp-server-installation) | Set up MCP servers standalone or in an existing Express server |
| [MCP Agent Installation](#mcp-agent-installation) | Install and initialize the MCP Agent component |
| [MCP Client Installation](#mcp-client-installation) | Just install the client to be used with different agent providers |
