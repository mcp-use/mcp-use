...
<Tip>
Check out [UI Widgets](/typescript/mcp-apps) with MCP Apps support and [Apps SDK compatibility](/typescript/mcp-apps/apps-sdk-compatibility) for ChatGPT. The Inspector previews MCP Apps widgets; see [Debug widgets in the Inspector](/inspector/debugging-chatgpt-apps).
</Tip>
...
<CardGroup cols={3}>
  ...
  <Card title="Server" icon="server" href="/typescript/server">
    The MCP Server framework implementation for TypeScript, with MCP Apps and Apps SDK support
  </Card>
</CardGroup>
