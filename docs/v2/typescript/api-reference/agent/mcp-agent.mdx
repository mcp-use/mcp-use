...
- [Agent guide](/v2/typescript/agent/index): task-focused guide for building MCP agents.
- [Streaming](/v2/typescript/agent/streaming): guide for step streaming and low-level event streaming.
- [Structured output](/v2/typescript/agent/structured-output): guide for Zod schema results.
- [Observability](/v2/typescript/agent/observability): guide for tracing, metadata, and callbacks.
