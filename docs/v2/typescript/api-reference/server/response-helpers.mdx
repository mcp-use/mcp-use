...
<Warning>
**Deprecated.** Prefer returning raw MCP envelopes (`CallToolResult`, `ReadResourceResult`, `GetPromptResult`). These helpers remain for upgrade compatibility and map to those shapes.
</Warning>
