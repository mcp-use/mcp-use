...
- [MCPServer](/v2/typescript/api-reference/server/mcp-server) for server lifecycle and registration methods.
- [Authentication](/v2/typescript/server/authentication) for OAuth provider setup.
