...
For task-based walkthroughs and concepts, use the [Docs](/v2/typescript/server) tab. This section is the precise reference you cite when you already know what you are building.
...
<CardGroup cols={2}>
  <Card
    title="mcp-use CLI"
    icon="terminal"
    href="/v2/typescript/api-reference/cli-reference"
  >
...
<Note>
Create a server with `new MCPServer({ ... })`. See the [MCPServer](/v2/typescript/api-reference/server/mcp-server) reference for the constructor and all of its methods.
</Note>
...
<CardGroup cols={3}>
  <Card
    title="MCPServer"
    icon="server"
    href="/v2/typescript/api-reference/server/mcp-server"
  >
  ...
  <Card
    title="Tools"
    icon="wrench"
    href="/v2/typescript/api-reference/server/tools"
  >
  ...
  <Card
    title="Resources"
    icon="file-text"
    href="/v2/typescript/api-reference/server/resources"
  >
  ...
  <Card
    title="Prompts"
    icon="message-square"
    href="/v2/typescript/api-reference/server/prompts"
  >
  ...
  <Card
    ...
    icon="box"
    href="/v2/typescript/api-reference/server/tool-context"
  >
  ...
  <Card
    ...
    icon="reply"
    href="/v2/typescript/api-reference/server/response-helpers"
  >
  ...
  <Card
    ...
    icon="list-checks"
    href="/v2/typescript/api-reference/server/elicitation-schemas"
  >
  ...
  <Card
    ...
    icon="shield"
    href="/v2/typescript/api-reference/server/auth"
  >
  ...
  <Card
    ...
    icon="plug"
    href="/v2/typescript/api-reference/server/auth-providers"
  >
  ...
  <Card
    ...
    icon="database"
    href="/v2/typescript/api-reference/server/sessions"
  >
  ...
  <Card
    ...
    icon="layers"
    href="/v2/typescript/api-reference/server/middleware"
  >
  ...
  <Card
    ...
    href="/v2/typescript/api-reference/server/widgets"
  >
...
<CardGroup cols={3}>
  <Card
    title="MCPClient"
    icon="router"
    href="/v2/typescript/api-reference/client/mcp-client"
  >
  ...
  <Card
    title="MCPConnection"
    icon="cable"
    href="/v2/typescript/api-reference/client/mcp-session"
  >
  ...
  <Card
    title="Code Mode"
    icon="code"
    href="/v2/typescript/api-reference/client/code-mode"
  >
  ...
  <Card
    title="React client"
    icon="react"
    href="/v2/typescript/api-reference/client/react-client"
  >
...
<CardGroup cols={3}>
  <Card
    title="useWidget()"
    icon="webhook"
    href="/v2/typescript/api-reference/react/usewidget"
  >
  ...
  <Card
    ...
    href="/v2/typescript/api-reference/react/usecalltool"
  >
  ...
  <Card
    title="useViewState()"
    icon="database"
    href="/v2/typescript/api-reference/react/useviewstate"
  >
  ...
  <Card
    title="useFiles()"
    icon="file-up"
    href="/v2/typescript/api-reference/react/usefiles"
  >
  ...
  <Card
    ...
    icon="component"
    href="/v2/typescript/api-reference/react/mcpuseprovider"
  >
  ...
  <Card
    ...
    href="/v2/typescript/api-reference/react/widgetcontrols"
  >
  ...
  <Card
    title="ThemeProvider"
    icon="palette"
    href="/v2/typescript/api-reference/react/themeprovider"
  >
  ...
  <Card
    title="ErrorBoundary"
    icon="shield-alert"
    href="/v2/typescript/api-reference/react/errorboundary"
  >
    Catch and display widget render errors.
  </Card>
  <Card title="Image" icon="image" href="/v2/typescript/api-reference/react/image">
    Render images with correct host URLs.
  </Card>
  <Card
    title="ModelContext"
    icon="brain"
    href="/v2/typescript/api-reference/react/modelcontext"
  >
