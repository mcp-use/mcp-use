...
`MCPClient` stores server configuration and returns [`MCPConnection`](/v2/typescript/api-reference/client/mcp-session) instances. The root export resolves to a Node or browser implementation automatically.
...
- [`MCPConnection`](/v2/typescript/api-reference/client/mcp-session)
- [Client overview](/v2/typescript/client/index)
- [Code mode](/v2/typescript/api-reference/client/code-mode)
