...
- [useWidget()](/v2/typescript/api-reference/react/usewidget) - Accessing widget props, state, and host context
- [Building UI Widgets](/v2/typescript/mcp-apps) - Complete widget development guide
