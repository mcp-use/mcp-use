...
- [`WidgetControls`](/v2/typescript/api-reference/react/widgetcontrols): debug and view controls.
- [`ThemeProvider`](/v2/typescript/api-reference/react/themeprovider): theme management.
- [`ErrorBoundary`](/v2/typescript/api-reference/react/errorboundary): error handling.
- [`useWidget`](/v2/typescript/api-reference/react/usewidget): widget hook for accessing props and actions.
