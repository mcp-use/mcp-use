...
<CardGroup cols={2}>
  <Card title="McpUseProvider" icon="plug" href="/v2/typescript/api-reference/react/mcpuseprovider">
    Unified provider that supplies widget context to components like `Image`.
  </Card>
  <Card title="useFiles" icon="folder-open" href="/v2/typescript/api-reference/react/usefiles">
