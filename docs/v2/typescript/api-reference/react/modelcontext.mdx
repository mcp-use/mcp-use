...
`ModelContext` describes what the user currently sees. mcp-use merges that description with [`useViewState`](/v2/typescript/api-reference/react/useviewstate) before sending it to the host.
...
| Need                                                                      | API                                                            |
| ------------------------------------------------------------------------- | -------------------------------------------------------------- |
| A cart, selection, draft, filter, or other structured model-visible value | [`useViewState`](/v2/typescript/api-reference/react/useviewstate) |
...
- [`useViewState`](/v2/typescript/api-reference/react/useviewstate)
- [`useToolContext`](/v2/typescript/api-reference/react/usewidget)
