...
- [McpUseProvider](/v2/typescript/api-reference/react/mcpuseprovider): Unified provider that can include `WidgetControls`.
- [useWidget](/v2/typescript/api-reference/react/usewidget): Hook for accessing widget data and actions, used internally by `WidgetControls`.
