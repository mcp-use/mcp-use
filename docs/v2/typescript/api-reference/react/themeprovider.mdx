...
- [`McpUseProvider`](/v2/typescript/api-reference/react/mcpuseprovider) includes `ThemeProvider` automatically.
- [`useWidget`](/v2/typescript/api-reference/react/usewidget) exposes the host context theme and other widget data.
