---
title: "Tools"
description: "Design and register typed actions on a TypeScript MCP server."
icon: "wrench"
---
...
Place the React entry at `views/<name>/view.tsx`, set `view.name` to that
directory name, and return its data in `structuredContent`.
