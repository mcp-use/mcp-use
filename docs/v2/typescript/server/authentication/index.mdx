...
This guide helps you choose the right authentication path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers) for exact provider options, defaults, return shapes, and verification behavior.
...
| Your provider advertises a `registration_endpoint` | [Custom Provider](/v2/typescript/server/authentication/providers/custom) |
| Your provider only gives you one fixed `clientId` and `clientSecret` | [OAuth Proxy](/v2/typescript/server/authentication/providers/oauth-proxy) |
...
- [Auth0](/v2/typescript/server/authentication/providers/auth0): Auth0 OAuth with Dynamic Client Registration.
- [Better Auth](/v2/typescript/server/authentication/providers/better-auth): Self-hosted OAuth with Better Auth's OAuth Provider plugin.
- [Clerk](/v2/typescript/server/authentication/providers/clerk): Clerk OAuth with user and organization claims.
- [Keycloak](/v2/typescript/server/authentication/providers/keycloak): Keycloak realm authentication with role mapping.
- [Supabase](/v2/typescript/server/authentication/providers/supabase): Supabase OAuth 2.1 server authentication.
- [WorkOS](/v2/typescript/server/authentication/providers/workos): WorkOS AuthKit authentication with organization context.
- [Custom Provider](/v2/typescript/server/authentication/providers/custom): Any DCR-capable OAuth provider with custom token verification.
...
Use [User Context](/v2/typescript/server/authentication/user-context) for access-control patterns inside tools.
...
<CardGroup cols={2}>
  ...
  <Card title="Auth providers API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers">
  ...
  <Card title="OAuth Proxy" icon="shuffle" href="/v2/typescript/server/authentication/providers/oauth-proxy">
