...
This guide covers the Auth0 setup path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers#oauthauth0provider) for exact `oauthAuth0Provider()` options, environment variable fallbacks, defaults, and errors.
...
Use [User Context](/v2/typescript/server/authentication/user-context) for broader access-control patterns.
...
<CardGroup cols={2}>
  ...
  <Card title="Auth0 provider API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers#oauthauth0provider">
