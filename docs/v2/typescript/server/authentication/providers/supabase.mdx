...
This guide covers the Supabase setup path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers#oauthsupabaseprovider) for exact `oauthSupabaseProvider()` options, defaults, and errors.
...
<CardGroup cols={2}>
  ...
  <Card title="Supabase provider API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers#oauthsupabaseprovider">
