...
This guide covers the Clerk setup path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers#oauthclerkprovider) for exact `oauthClerkProvider()` options, defaults, and errors.
...
<CardGroup cols={2}>
  ...
  <Card title="Clerk provider API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers#oauthclerkprovider">
