...
This guide covers the Keycloak setup path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers#oauthkeycloakprovider) for exact `oauthKeycloakProvider()` options, defaults, and errors.
...
<CardGroup cols={2}>
  ...
  <Card title="Keycloak provider API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers#oauthkeycloakprovider">
