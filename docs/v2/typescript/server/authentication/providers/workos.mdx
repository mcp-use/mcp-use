...
This guide covers the WorkOS setup path. Use the [auth providers API reference](/v2/typescript/api-reference/server/auth-providers#oauthworkosprovider) for exact `oauthWorkOSProvider()` options, defaults, and errors.
...
Use [User Context](/v2/typescript/server/authentication/user-context) for shared access-control patterns.
...
<CardGroup cols={2}>
  ...
  <Card title="WorkOS provider API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth-providers#oauthworkosprovider">
