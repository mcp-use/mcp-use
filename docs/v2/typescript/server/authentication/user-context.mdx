...
This guide focuses on access-control patterns. Use the [Auth API reference](/v2/typescript/api-reference/server/auth) for the exact `AuthInfo` and `UserInfo` fields.
...
<CardGroup cols={2}>
  ...
  <Card title="Auth API reference" icon="terminal" href="/v2/typescript/api-reference/server/auth">
  ...
  <Card title="Auth providers API reference" icon="plug" href="/v2/typescript/api-reference/server/auth-providers">
