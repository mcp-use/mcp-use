...
Helpers build a tool-shaped `CallToolResult`. Resource and prompt callbacks may still return them; the server converts to `ReadResourceResult` / `GetPromptResult`. Use the [Response helpers API reference](/v2/typescript/api-reference/server/response-helpers) for signatures.
...
<Card title="Response helpers API reference" icon="terminal" href="/v2/typescript/api-reference/server/response-helpers" horizontal>
