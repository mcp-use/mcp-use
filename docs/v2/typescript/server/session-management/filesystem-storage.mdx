...
This guide focuses on the development workflow. Use the [Sessions API reference](/v2/typescript/api-reference/server/sessions#filesystemsessionstore) for constructor fields, defaults, cleanup behavior, and file format details.
...
Use [Redis Storage](/v2/typescript/server/session-management/redis-storage) for distributed deployments.
...
<CardGroup cols={2}>
  <Card title="In-Memory Storage" icon="memory-stick" href="/v2/typescript/server/session-management/memory-storage">
  ...
  <Card title="Sessions API reference" icon="terminal" href="/v2/typescript/api-reference/server/sessions#filesystemsessionstore">
