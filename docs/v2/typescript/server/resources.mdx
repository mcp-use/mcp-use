...
This guide focuses on when and how to register resources. Use the [Resources API reference](/v2/typescript/api-reference/server/resources) for exact definition fields, callback signatures, MIME behavior, annotations, and return types.
...
| Interactive UI rendered in a client | [MCP Apps](/v2/typescript/mcp-apps) |
| An operation that changes state or calls a workflow | [Tools](/v2/typescript/server/tools) |
...
See [Response Helpers](/v2/typescript/server/response-helpers) for a chooser and [Response helpers API reference](/v2/typescript/api-reference/server/response-helpers) for exact MIME and return behavior.
...
See [Resource Subscriptions](/v2/typescript/server/subscriptions) and [Notifications](/v2/typescript/server/notifications) for update workflows.
...
<CardGroup cols={2}>
  <Card title="Resources API reference" icon="terminal" href="/v2/typescript/api-reference/server/resources">
