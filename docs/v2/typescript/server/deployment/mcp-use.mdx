...
See the [CLI reference](/v2/typescript/api-reference/cli-reference#login---authenticate-with-manufact-cloud) for `--api-key` and `--org` options.
...
- [CLI reference](/v2/typescript/api-reference/cli-reference#deploy---cloud-deployment) - mcp-use CLI behavior in this SDK.
- [ServerConfig API reference](/v2/typescript/api-reference/server/server-config) - Advanced server configuration options.
- [MCP Apps](/v2/typescript/mcp-apps) - Build interactive widgets for MCP clients.
