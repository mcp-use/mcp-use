...
For the main widget workflow, see [Build widgets](/v2/typescript/mcp-apps/widgets). For ChatGPT compatibility behavior, see [Apps SDK compatibility](/v2/typescript/mcp-apps/apps-sdk-compatibility).
