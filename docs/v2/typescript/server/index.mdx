...
If you are starting from scratch, use the [TypeScript quickstart](/v2/typescript/getting-started/quickstart) to scaffold a server. Use [Build your first MCP App](/v2/typescript/mcp-apps/quickstart) when the server should return React widgets.
...
Learn more in [MCP Apps](/v2/typescript/mcp-apps) and [useWidget()](/v2/typescript/api-reference/react/usewidget).
