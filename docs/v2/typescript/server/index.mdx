---
title: "Overview"
description: "Understand the stateless server foundation behind every mcp-use v2 MCP App."
icon: "list-start"
---

mcp-use v2 is a full-stack TypeScript framework for MCP Apps. Every app is powered by a stateless `MCPServer` that exposes capabilities to AI clients and can render interactive React Views.
...
## What the v2 MCP Apps framework provides
...
See [`ServerConfig`](/v2/typescript/api-reference/server/server-config) for the complete configuration surface.
