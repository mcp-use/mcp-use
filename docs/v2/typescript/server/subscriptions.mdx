...
This guide focuses on the server workflow. Use the [MCPServer API reference](/v2/typescript/api-reference/server/mcp-server) for the exact `notifyResourceUpdated()` signature and related session behavior.
...
| Broadcast a job status event | [Notifications](/v2/typescript/server/notifications) |
...
<CardGroup cols={2}>
  ...
  <Card title="MCPServer API reference" icon="server" href="/v2/typescript/api-reference/server/mcp-server">
