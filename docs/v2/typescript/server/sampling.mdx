...
This guide focuses on when to use sampling and how to keep tools resilient. Use the [Tool context API reference](/v2/typescript/api-reference/server/tool-context#sample) for exact overloads, options, progress behavior, defaults, and return shapes.
...
Sampling can take time. If the client supplied a progress token, mcp-use can report progress while waiting. For custom progress handling or intervals, see the [Tool context API reference](/v2/typescript/api-reference/server/tool-context#sample).
...
Use [Notifications](/v2/typescript/server/notifications) for broader server-to-client notification workflows.
...
<CardGroup cols={2}>
  <Card title="Tool context API reference" icon="terminal" href="/v2/typescript/api-reference/server/tool-context#sample">
    Look up `ctx.sample()` overloads, options, progress behavior, and return shapes.
  </Card>
  <Card title="Elicitation" icon="check" href="/v2/typescript/server/elicitation">
  ...
  <Card title="Client sampling" icon="monitor" href="/v2/typescript/client/sampling">
