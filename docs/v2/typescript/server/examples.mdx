...
- [TypeScript server quickstart](/v2/typescript/getting-started/quickstart): Create and run a new TypeScript server locally.
- [Deploy to Manufact Cloud](/v2/typescript/server/deployment/mcp-use): Deploy a TypeScript MCP server and get a hosted `/mcp` endpoint.
