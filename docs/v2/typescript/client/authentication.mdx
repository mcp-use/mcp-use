...
OAuth callback: import `onMcpAuthorization` from `@mcp-use/client/react` on your callback route. See [React integration](/v2/typescript/client/usemcp#oauth-callback).
