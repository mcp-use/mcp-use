...
Upgrading from v1? See the [v2 migration guide](/v2/typescript/client/migration).
...
<CardGroup cols={2}>
  ...
  <Card title="v2 Migration" icon="arrow-right-left" href="/v2/typescript/client/migration">
