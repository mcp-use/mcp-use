...
<Warning>
  You are viewing the **V2 beta** documentation. This first-pass documentation
  set reflects the pages already present on the V2 branch, so some sections are
  still incomplete or uneven. Use the version switcher to return to the
  [V1 stable documentation](/typescript/getting-started/welcome).
</Warning>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/v2/typescript/getting-started/quickstart">
    Build your first MCP server in under 5 minutes.
  </Card>
  <Card title="Installation" icon="download" href="/v2/typescript/getting-started/installation">
