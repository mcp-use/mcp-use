...
Building an AI agent or MCP Client instead? Head to the [MCP Agent](/v2/typescript/agent/index) or [MCP Client](/v2/typescript/client/index) introductions instead.
...
The first command saves the server under the name `local`; later commands address it by that name. See the [CLI client](/v2/typescript/tooling/client-cli) reference for the full command set.
...
<Tip>
  See [Tools](/v2/typescript/server/tools),
  [Resources](/v2/typescript/server/resources), and
  [Prompts](/v2/typescript/server/prompts) for the full API, and [MCP
  Apps](/v2/typescript/mcp-apps) to build widgets.
</Tip>
