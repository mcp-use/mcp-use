...
Keep provider-specific tuning in `llmConfig` or `ProviderConfig`. See the [MCPAgent API reference](/v2/typescript/api-reference/agent/mcp-agent) for the complete option types.
