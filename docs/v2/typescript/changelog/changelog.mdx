...
- **Refactor**: Replaced Winston with `SimpleConsoleLogger` that works across all environments. See the [ServerConfig API reference](/v2/typescript/api-reference/server/server-config) for server environment settings.
