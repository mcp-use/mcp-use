...
- Use [`useCallTool()`](/v2/typescript/api-reference/react/usecalltool) for full call state and typing details.
- Use [`useWidget()`](/v2/typescript/api-reference/react/usewidget) for all host actions and display-mode behavior.
