...
- Use [`useToolContext()`](/v2/typescript/api-reference/react/usewidget) to read tool input, output, and lifecycle status.
- Use [`useCallTool()`](/v2/typescript/api-reference/react/usecalltool) when a view needs to call another MCP tool.
