...
- Read the [`useViewState` API reference](/v2/typescript/api-reference/react/useviewstate) for signatures, errors, and host behavior.
- Read the [`ModelContext` API reference](/v2/typescript/api-reference/react/modelcontext) for nesting and imperative entries.
