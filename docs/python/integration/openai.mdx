...
tag: "New"
icon: "); -webkit-mask-image: url('https://raw.githubusercontent.com/mcp-use/mcp-use/refs/heads/feat/adapter_integrations/docs/python/integration/logos/openai.svg');/*"
---
