...
tag: "New"
icon: "); -webkit-mask-image: url('https://raw.githubusercontent.com/mcp-use/mcp-use/refs/heads/feat/adapter_integrations/docs/python/integration/logos/anthropic.svg');/*"
---
...
### Step 2: Create the Anthropic Adapter
...
### Step 3: Generate Anthropic-Compatible Tools
