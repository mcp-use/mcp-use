...
Execute Python code with access to MCP tools (code mode).
        ...
        Example:
            ...
            result = await search_tools("github")
            tools = result['results']
            print(f"Found \{len(tools)\} tools out of \{result['meta']['total_tools']\} total")
...
**Returns**
><ResponseField name="returns" type="dict[str, Any]" >Dictionary with: - meta: Dictionary containing total_tools, namespaces, and result_count - results: List of tool information dictionaries matching the query Level of detail to return: - &quot;names&quot;: Only tool names and server - &quot;descriptions&quot;: Names, server, and descriptions - &quot;full&quot;: Complete tool information including schemas</ResponseField>
