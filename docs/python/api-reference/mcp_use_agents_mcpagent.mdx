...
><ParamField body="pretty_print" type="bool | None" default="None" >   Boolean flag </ParamField>
...
><ParamField body="output_schema" type="type[~T] | None" default="None" >   Optional Pydantic BaseModel class for structured output. </ParamField>
><ParamField body="pretty_print" type="bool | None" default="None" >   Whether to format output with pretty printing. </ParamField>
