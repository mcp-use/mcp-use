...
**Signature**
```python wrap
def on_call_tool(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_get_prompt(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_initialize(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_list_prompts(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_list_resources(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_list_tools(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
...
**Signature**
```python wrap
def on_read_resource(context: ServerMiddlewareContext[Any], call_next: CallNext[Any, Any]):
```
