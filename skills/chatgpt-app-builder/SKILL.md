...
description: |
  DEPRECATED: Use **`mcp-apps-builder`** (`skills/mcp-apps-builder/`). ChatGPT and MCP Apps
  share the same inline JSX flow. Install: `npx skills install mcp-use/mcp-use --skill mcp-apps-builder`
